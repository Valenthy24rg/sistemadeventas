                    ...
                    <div class="card-body">
                        <form action="{{route('bills.create')}}" method="post">
                            ...
                            <div style="margin-bottom: 1em;">
                                ...
                                <input type="text" name="subtotal" id="subtotal" class="form-control" placeholder="Enter subtotal" value="{{ old('subtotal') }}">
                                @error('subtotal')
                            ...
                            <div style="margin-bottom: 1em;">
                                ...
                                <input type="text" name="total" id="total" class="form-control" placeholder="Enter Total" value="{{ old('total') }}">
                                @error('total')
